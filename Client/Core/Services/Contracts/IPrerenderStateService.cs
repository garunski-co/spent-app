...
///     https://docs.microsoft.com/en-us/aspnet/core/blazor/components/prerendering-and-integration#persist-prerendered-state).
///     If your project does not require prerendering to be enabled, you can completely remove this service and its usages
///     from your project.
/// </summary>
public interface IPrerenderStateService
{
    ...
    ///     and ApplicationState.PersistAsJson (explained here:
    ///     https://docs.microsoft.com/en-us/aspnet/core/blazor/components/prerendering-and-integration#persist-prerendered-state),
    ...
    /// </summary>
    Task<T?> GetValue<T>([UsedImplicitly] string key, Func<Task<T?>> factory);
}
